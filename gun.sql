...
--
-- Table structure for table `f4473`
--

DROP TABLE IF EXISTS `f4473`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `f4473` (
  ...
  PRIMARY KEY (`id`),
  KEY `idx_f4473_name_fname_lname` (`name`,`fname`,`lname`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `f4473`
--

LOCK TABLES `f4473` WRITE;
/*!40000 ALTER TABLE `f4473` DISABLE KEYS */;
/*!40000 ALTER TABLE `f4473` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2018-12-21 12:02:25
